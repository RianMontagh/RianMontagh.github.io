...
I decided to spend some time with a report titled "FLOOD FREQUENCY ANALYSIS AT DEMING, FERNDALE, AND EVERSON" written by Delbert D. Franz of Linsley, Kraeger Associates, Limited. This report goes into detail on the methods used to reconstruct the return periods for flooding at Ferndale, Deming, and the overflow gage at Main St. The usual methods don't work here because 1) the gage at Deming is unreliable and 2) Some of the Ferndale annual peak flows are affected by the overflow at Everson (mixed population). Delbert used the general following methodology to get his peak flows at Ferndale, Deming, and the overflow gage at Main St. 

Steps for Deming Return Periods 

1. Run unsteady flow models of historic floods and extract 15 historic peak flows to get paired Deming and Ferndale peak flows. They calibrated these models to match stable Ferndale flows, and then figuring out what the Deming flows must have been. This way they avoiding using direct Deming observations. 
2. Get a statistical relationship that allows you to go from the modeled Ferndale peak flows to the modeled Deming peak flows.
3. Apply this relationship to the full period of record of Ferndale peak flows (stable) (n=57) to get 57 Deming peak flow points.
4. Run a Log-Pearson Type III analysis on the 57 constructed Deming flows to get the frequency analysis.
...
1. Run scaled up, larger flows to supplement the historic events and get wider range of Deming flows.
...
:-------------------------:|:-------------------------:|:-------------------------:
![](https://github.com/user-attachments/assets/03cbb014-14b0-4080-88d3-e459872f0ae7)  |  ![](https://github.com/user-attachments/assets/77357114-d64e-4757-a7e2-78fb87025739)  |  ![](https://github.com/user-attachments/assets/5214735a-45e8-46ee-a08c-7c35b221c4be)
